...
export const GAP_ATTACK_BLOGS: GapAttackContent[] = [
  ...
  { slug: 'best-dog-bed-for-hip-dysplasia', title: 'Best Dog Beds for Hip Dysplasia – Popular Options', primaryKeyword: 'best dog bed for hip dysplasia', type: 'blog', targetCollection: 'best-orthopedic-dog-beds', relatedArticles: ['best-orthopedic-dog-beds-2026', 'calming-dog-bed-guide'], faqQuestions: ['What type of bed is best for a dog with hip dysplasia?', 'Is memory foam good for dogs with joint pain?'], estimatedSearchVolume: 480, difficulty: 'low' },
  { slug: 'best-dog-bed-for-labrador', title: 'Best Dog Beds for Labradors – our picks for 2026', primaryKeyword: 'best dog bed for labrador', type: 'blog', targetCollection: 'best-dog-beds-for-large-dogs', relatedArticles: ['best-orthopedic-dog-beds-2026'], faqQuestions: ['What size bed does a Labrador need?', 'Do Labs prefer bolster or flat beds?'], estimatedSearchVolume: 720, difficulty: 'low' },
...
export const GAP_ATTACK_BUYER_GUIDES: GapAttackContent[] = [
  ...
  { slug: 'best-interactive-dog-toys-2026', title: 'Best Interactive Dog Toys 2026 – Compared & Ranked', primaryKeyword: 'best interactive dog toys 2026', type: 'buyer_guide', targetCollection: 'best-interactive-dog-toys', relatedArticles: ['dog-puzzle-toys-guide', 'signs-your-dog-is-bored'], faqQuestions: ['What are the best enrichment toys for dogs?', 'Are interactive toys good for dogs?'], estimatedSearchVolume: 1100, difficulty: 'medium' },
  ...
  { slug: 'best-dog-car-seats-2026', title: 'Best Dog Car Seats 2026 – safety-focused & carefully selected', primaryKeyword: 'best dog car seats 2026', type: 'buyer_guide', targetCollection: 'best-dog-car-seats', relatedArticles: ['how-to-keep-dog-safe-in-car', 'best-dog-car-seats-for-anxious-dogs'], faqQuestions: ['Are dog car seats crash tested?', 'What is the safest dog car seat?'], estimatedSearchVolume: 1200, difficulty: 'medium' },
