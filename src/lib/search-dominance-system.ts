...
export const LINKING_MATRIX_SAMPLE: LinkingMatrixEntry[] = [
  {
    ...
    sourceType: 'homepage',
    targets: [
      { url: '/collections/orthopedic-calming-dog-beds', anchorType: 'exact' },
      { url: '/collections/cat-condos', anchorType: 'exact' },
      { url: '/collections/best-interactive-dog-toys', anchorType: 'exact' },
      { url: '/collections/best-cat-litter-boxes', anchorType: 'exact' },
      ...
      { url: '/collections/best-dog-harnesses', anchorType: 'branded' },
      { url: '/collections/automatic-cat-feeders', anchorType: 'natural' },
      { url: '/collections/best-cat-carriers', anchorType: 'natural' },
    ],
  },
  {
    source: '/collections/orthopedic-calming-dog-beds',
    sourceType: 'pillar',
    targets: [
