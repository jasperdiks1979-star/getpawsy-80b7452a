...
export const PRIORITY_CATEGORIES: CategorySerpConfig[] = [
  // ── 1. ORTHOPEDIC DOG BEDS ──
  {
    ...
    title: 'Best Orthopedic Dog Beds 2026 – Vet-Approved Joint Relief',
    metaDescription: 'Your dog wakes up stiff? Orthopedic memory foam beds relieve joint pain in 7 days. Vet-approved, waterproof, 30-day guarantee. Free US shipping.',
    ogTitle: 'Best Orthopedic Dog Beds — Vet-Approved Joint Relief (2026)',
    ogDescription: 'Premium memory foam dog beds for arthritis & hip dysplasia. Trusted by 10,000+ pet parents. Free US shipping over $35.',
    h1: 'Best Orthopedic Dog Beds — Vet-Approved Joint Relief',
    faqItems: [
    ...
    productLinks: [
      { href: '/dog/orthopedic-dog-beds/memory-foam', anchor: 'memory foam dog beds', anchorType: 'exact' },
      { href: '/dog/orthopedic-dog-beds/best-for-large-dogs', anchor: 'beds for large dog breeds', anchorType: 'partial' },
      { href: '/dog/orthopedic-dog-beds/waterproof', anchor: 'explore waterproof options', anchorType: 'natural' },
  ...
  // ── 2. CAT TREES FOR LARGE CATS ──
  {
    ...
    productLinks: [
      { href: '/cat/cat-trees-for-large-cats/heavy-duty', anchor: 'heavy duty cat trees', anchorType: 'exact' },
      { href: '/cat/cat-trees-for-large-cats/for-maine-coon', anchor: 'cat trees designed for Maine Coons', anchorType: 'partial' },
      { href: '/cat/cat-trees-for-large-cats/large-cat-condos', anchor: 'browse large cat condos', anchorType: 'natural' },
  ...
  // ── 3. DOG CAR TRAVEL SAFETY ──
  {
    ...
    metaDescription: 'Your dog rides unrestrained? A 60-lb dog at 35 mph = 2,700 lbs of force. Shop crash-tested car seats & harnesses. 30-day guarantee + free US shipping.',
    ...
    productLinks: [
      { href: '/dog/dog-car-travel-safety/car-seats', anchor: 'dog car seats', anchorType: 'exact' },
      { href: '/dog/dog-car-travel-safety/harness', anchor: 'crash-tested dog harnesses for cars', anchorType: 'partial' },
      { href: '/dog/dog-car-travel-safety/booster-seats', anchor: 'see our booster seat collection', anchorType: 'natural' },
