...
export const PRIORITY_CATEGORIES: CategorySerpConfig[] = [
  // ── 1. ORTHOPEDIC DOG BEDS ──
  {
    ...
    faqItems: [
      ...
      { question: 'What is the best orthopedic bed for large breed dogs?', answer: 'Large breeds (70+ lbs) need beds with 6+ inches of 3.0+ lb/ft³ density foam, minimum 44×34 inch sleeping surfaces, and reinforced bolsters. Look for beds with waterproof liners and non-slip bottoms.' },
    ],
    guideLinks: [
  ...
  // ── 2. CAT TREES FOR LARGE CATS ──
  {
    ...
    metaDescription: 'Tired of wobbly cat trees? Heavy-duty trees rated for 25+ lb cats. Reinforced bases and thick sisal posts. Free shipping available.',
    ogTitle: 'Best Cat Trees for Large Cats — Heavy Duty & Reinforced',
    ogDescription: 'Purpose-built cat trees for Maine Coons & large breeds. Thick sisal posts, wide platforms, free US shipping.',
    h1: 'Best Cat Trees for Large Cats — Heavy Duty & Reinforced',
    faqItems: [
      { question: 'Are large cat trees stable enough for heavy cats?', answer: 'Quality heavy-duty cat trees are absolutely stable for heavy cats — IF they\'re purpose-built. Look for solid wood or engineered wood bases (24×24" minimum), 4"+ diameter sisal posts, and wall-anchor hardware. Standard pressed-board trees are NOT stable for cats over 15 lbs.' },
  ...
  // ── 3. DOG CAR TRAVEL SAFETY ──
  {
    ...
    namespace: 'dog',
    canonical: 'https://getpawsy.pet/collections/all',
    title: 'Dog Car Seats & Travel Safety Gear (2026)',
    metaDescription: 'Your dog rides unrestrained? A 60-lb dog at 35 mph = 2,700 lbs of force. Shop dog car seats & harnesses. 30-day return policy + free US shipping.',
    ogTitle: 'Dog Car Seats & Travel Safety Gear (2026)',
