...
export const PRIORITY_CATEGORIES: CategorySerpConfig[] = [
  // ── 1. ORTHOPEDIC DOG BEDS ──
  {
    ...
    metaDescription: 'Dog waking up stiff? Vet-approved memory foam beds relieve joint pain in 7 days. Waterproof, washable, 30-day guarantee. Free US shipping over $35.',
