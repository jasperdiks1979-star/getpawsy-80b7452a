...
export const DEPTH_MAP: DepthEntry[] = [
  ...
  { path: '/cat/litter-box-guides',     label: 'Litter Box Guides Pillar',      depth: 2, tier: 2, priority: 0.90 },
  { path: '/cat/cat-behavior',          label: 'Cat Behavior Pillar',           depth: 2, tier: 2, priority: 0.90 },
