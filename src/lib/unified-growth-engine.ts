...
const SNIPER_SEED: Array<{
  ...
  {
    url: '/dog/orthopedic-dog-beds', query: 'best orthopedic dog bed 2026',
    impressions: 4200, clicks: 126, position: 8.2, aov: 65,
    title: '7 Best Orthopedic Dog Beds — Vet-Backed Picks (2026)',
    meta: 'Joint pain keeps your dog up at night. These orthopedic beds use medical-grade foam to relieve pressure. Free US shipping + 30-day guarantee.',
  ...
  {
    url: '/cat/cat-trees-for-large-cats', query: 'cat tree for large cats',
  ...
  {
    url: '/dog/dog-car-seats', query: 'crash tested dog car seat',
  ...
  },
  {
    ...
    linkSources: ['/collections/dog-beds', '/blog/summer-pet-care', '/guides/best-dog-beds-large-breeds-2026', '/dog/orthopedic-dog-beds', '/'],
  },
  {
    ...
    meta: 'Anxiety affects 70% of dogs. These donut-style beds mimic den security with raised rims and ultra-soft faux fur. 30-day comfort guarantee.',
    ...
    linkSources: ['/blog/dog-anxiety-tips', '/collections/dog-beds', '/dog/orthopedic-dog-beds', '/guides/signs-your-dog-has-joint-pain', '/'],
  },
  {
  ...
  },
  {
    ...
    linkSources: ['/cat/cat-trees-for-large-cats', '/guides/sisal-vs-carpet-scratching-posts', '/collections/cat-toys', '/blog/cat-enrichment-guide', '/'],
  },
  {
    ...
    linkSources: ['/dog/dog-car-seats', '/guides/dog-travel-safety-laws-by-state', '/blog/road-trip-with-dogs', '/collections/dog-bowls', '/'],
  },
  {
    ...
    linkSources: ['/collections/cat-bowls', '/blog/cat-nutrition-guide', '/cat/cat-trees-for-large-cats', '/', '/blog/smart-pet-tech'],
  },
  {
  ...
  },
  {
    ...
    linkSources: ['/collections/dog-beds', '/blog/crate-training-guide', '/dog/orthopedic-dog-beds', '/', '/blog/large-breed-care'],
  },
  {
    ...
    linkSources: ['/cat/cat-trees-for-large-cats', '/guides/cat-tree-stability-guide', '/collections/cat-toys', '/', '/blog/indoor-cat-enrichment'],
  },
  {
    ...
    linkSources: ['/collections/dog-beds', '/blog/summer-pet-safety', '/dog/orthopedic-dog-beds', '/', '/collections/elevated-dog-beds'],
  },
  {
...
function buildLockdownNiche(): LockdownNiche {
  return {
    ...
    hubUrl: '/dog/orthopedic-dog-beds',
    dominanceScore: 78,
    clusterArticles: [
    ...
    internalLinkMap: [
      { source: '/', target: '/dog/orthopedic-dog-beds', anchorType: 'exact' },
      { source: '/collections/dog-beds', target: '/dog/orthopedic-dog-beds', anchorType: 'partial' },
      { source: '/guides/how-to-choose-orthopedic-dog-bed', target: '/dog/orthopedic-dog-beds', anchorType: 'exact' },
      { source: '/guides/signs-your-dog-has-joint-pain', target: '/dog/orthopedic-dog-beds', anchorType: 'natural' },
      { source: '/guides/memory-foam-vs-regular-dog-bed', target: '/dog/orthopedic-dog-beds', anchorType: 'partial' },
      { source: '/blog/senior-dog-care', target: '/dog/orthopedic-dog-beds', anchorType: 'natural' },
      { source: '/blog/large-breed-essentials', target: '/dog/orthopedic-dog-beds', anchorType: 'partial' },
      { source: '/dog/orthopedic-dog-beds', target: '/products/memory-foam-bed-xl', anchorType: 'product' },
      { source: '/dog/orthopedic-dog-beds', target: '/products/cooling-orthopedic-bed', anchorType: 'product' },
      { source: '/dog/orthopedic-dog-beds', target: '/products/waterproof-orthopedic-bed', anchorType: 'product' },
    ],
...
function buildVelocityLeaders(): VelocityPage[] {
  const pages: VelocityPage[] = [
    { url: '/dog/orthopedic-dog-beds', query: 'orthopedic dog bed', clickGrowthPct: 38, impressionGrowthPct: 22, positionDelta: -2.1, velocityScore: 92, action: 'double_links', revenuePerMonth: 485 },
    { url: '/cat/cat-trees-for-large-cats', query: 'cat tree large cats', clickGrowthPct: 31, impressionGrowthPct: 18, positionDelta: -1.8, velocityScore: 84, action: 'double_links', revenuePerMonth: 620 },
    ...
    { url: '/dog/dog-car-seats', query: 'dog car seat', clickGrowthPct: 15, impressionGrowthPct: 10, positionDelta: -0.6, velocityScore: 44, action: 'boost_homepage', revenuePerMonth: 165 },
  ...
  return [
    {
      ...
      pages: [
        ...
        { url: '/dog/orthopedic-dog-beds', position: 22.1, impressions: 320 },
      ],
      severity: 'high',
    ...
    },
    {
      ...
      pages: [
        { url: '/cat/cat-trees-for-large-cats', position: 11.5, impressions: 3800 },
