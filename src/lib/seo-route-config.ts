...
export const LEGACY_REDIRECT_MAP: Record<string, string> = {
  ...
  '/orthopedic-dog-beds/best-for-large-dogs': '/dog/orthopedic-dog-beds/best-for-large-dogs',
  '/orthopedic-dog-beds/for-senior-dogs': '/dog/orthopedic-dog-beds/for-senior-dogs',
  '/orthopedic-dog-beds/washable-covers': '/dog/orthopedic-dog-beds/washable-covers',
  '/orthopedic-dog-beds/memory-foam-vs-egg-crate': '/dog/orthopedic-dog-beds/memory-foam-vs-egg-crate',
  '/cat-trees-for-large-cats/heavy-duty': '/cat/cat-trees-for-large-cats/heavy-duty',
  '/cat-trees-for-large-cats/for-multiple-cats': '/cat/cat-trees-for-large-cats/for-multiple-cats',
  '/cat-trees-for-large-cats/tall-vs-wide': '/cat/cat-trees-for-large-cats/tall-vs-wide',
  '/cat-trees-for-large-cats/apartments-small-spaces': '/cat/cat-trees-for-large-cats/apartments-small-spaces',
  '/dog-car-travel-safety/crash-tested-seat-belts': '/dog/dog-car-travel-safety/crash-tested-seat-belts',
  '/dog-car-travel-safety/booster-seats': '/dog/dog-car-travel-safety/booster-seats',
  '/dog-car-travel-safety/back-seat-hammocks': '/dog/dog-car-travel-safety/back-seat-hammocks',
  '/dog-car-travel-safety/anxious-dog-road-trips': '/dog/dog-car-travel-safety/anxious-dog-road-trips',
};
