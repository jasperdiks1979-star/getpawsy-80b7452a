...
export const SNIPER_TARGETS: SniperTarget[] = [
  ...
  },
  {
    ...
    optimization: {
      ...
      newMetaDescription: 'Your arthritic dog deserves real relief. Memory foam beds reduce joint inflammation 40%. Vet-recommended, washable. Free US shipping + 30-day guarantee.',
      faqSchema: [
