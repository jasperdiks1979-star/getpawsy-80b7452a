...
const FIXTURES: Fixture[] = [
  ...
  { label: "anxiety bed", expected: "calming_bed",
    product: { name: "Anxiety Calming Bed", slug: "anxiety-pet-bed", category: "Pet Beds" } },
  ...
  { label: "puzzle treat dispenser", expected: "interactive_toy",
    product: { name: "Interactive Puzzle Toy", slug: "puzzle-treat-dispenser", category: "Dog Toys" } },
