    ...
    .map(([page, targets]) => {
      ...
      return {
        ...
        faqEntries: allQueries.slice(0, 3).map(q => ({
          ...
          answer: `Our ${q} selection is tested by pet care experts. Each product ships with fast delivery to the US and a 30-day satisfaction guarantee. View our curated picks above.`,
        })),
        internalLinks: [
