  ...
  const optimizedProducts: ProductOptimization[] = Array.from(pageMap.entries())
    ...
    .map(([page, targets]) => {
      ...
      return {
        ...
        metaRewrite: `Find the ${primaryKw} your pet deserves. Independently tested, shipped from US warehouses in 3-7 days. Shop now with free shipping over $35.`,
        ...
        trustBlocks: ['Free US Shipping Over $35', '30-Day Returns', 'Secure Checkout', 'US Warehouse Fulfillment'],
