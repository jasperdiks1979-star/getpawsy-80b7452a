...
const GoogleEnterprisePage = lazyWithRetry(() => import("./pages/admin/GoogleEnterprisePage"));
...
const PinterestResurrectionPage = lazyWithRetry(() => import("./pages/admin/PinterestResurrectionPage"));
...
const FinanceCommanderPage = lazyWithRetry(() => import("./pages/admin/FinanceCommanderPage"));
...
const OrganicGrowthIntelligencePage = lazyWithRetry(() => import("./pages/admin/OrganicGrowthIntelligencePage"));
const ExecutiveGrowthIntelligencePage = lazyWithRetry(() => import("./pages/admin/ExecutiveGrowthIntelligencePage"));
                      ...
                      <RouteErrorBoundary>
                        <Routes>
                          ...
                          >
                            ...
                            />
                            <Route
                              path="google-enterprise"
                              element={
                                <Suspense fallback={<RouteLoader />}>
                                  <GoogleEnterprisePage />
                                </Suspense>
                              }
                            />
                            <Route
                            ...
                            />
                            <Route
                              path="pinterest-wave-opportunity"
                              element={
                                <Suspense fallback={<RouteLoader />}>
