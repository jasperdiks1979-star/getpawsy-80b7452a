  ...
  return (
    <Layout>
      ...
      <Helmet>
        ...
        <meta name="description" content="Trainer-approved no-pull harnesses, recall leashes & positive reinforcement tools. Reduce pulling 40–60% on first walk. Free US shipping over $49. 30-day guarantee." />
