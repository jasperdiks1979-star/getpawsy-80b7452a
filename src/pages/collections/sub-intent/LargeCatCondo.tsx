...
export default function LargeCatCondo() {
  return (
    <SubIntentPage
      canonical="https://getpawsy.pet/collections/cat-condos-for-large-cats"
      ...
      ctaLink="/products?category=cat-trees-and-condos"
      trustBadges={['12"+ Openings', '3–7 Day US Shipping', '30-Day Guarantee']}
      breadcrumbs={[
        { label: 'Home', href: '/' },
