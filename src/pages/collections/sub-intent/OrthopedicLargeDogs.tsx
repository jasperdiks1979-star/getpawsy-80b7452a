...
export default function OrthopedicLargeDogs() {
  return (
    <SubIntentPage
      canonical="https://getpawsy.pet/collections/best-orthopedic-dog-bed-large-dogs"
      ...
      ctaLink="/products?category=dog-beds"
      trustBadges={['Rated for 50–150+ lbs', '3–7 Day US Shipping', '30-Day Comfort Guarantee']}
      breadcrumbs={[
        { label: 'Home', href: '/' },
