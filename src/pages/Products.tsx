...
const Products = () => {
  ...
  const metaDescription = categoryDisplayName
    ...
    : searchQuery
      ? `Find "${searchQuery}" at GetPawsy. Browse our collection of premium pet products. Free US shipping on orders over $49. Quality supplies for dogs, cats & more.`
      : 'Shop premium pet products at GetPawsy. Quality supplies for dogs, cats & more. From cozy beds to durable toys, we have everything your furry friend needs. Free US shipping over $49!';
