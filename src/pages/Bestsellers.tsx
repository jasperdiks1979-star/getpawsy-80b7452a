...
const Bestsellers = () => {
  ...
  const bestsellerFaqs = [
    ...
    { question: 'Do bestseller products come with a warranty?', answer: 'Most bestseller products include a manufacturer warranty. Additionally, our 30-day return guarantee covers any defects or dissatisfaction. Check individual product pages for specific warranty details.' },
