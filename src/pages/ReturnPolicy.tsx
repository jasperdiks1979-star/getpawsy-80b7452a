  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="GetPawsy 30-day return policy. Returns by mail, customer pays return shipping. Refund to original payment method within 5 business days. Contact info@getpawsy.pet." />
