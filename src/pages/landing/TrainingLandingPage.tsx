    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/dog/dog-training-behavior-tools" className="text-primary underline">← Browse Training Gear</Link>
        </div>
      </div>
    );
  }
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div>
            ...
            <div className="space-y-1.5 mb-4">
              ...
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                <RotateCcw className="w-3.5 h-3.5 text-primary" /><span>30-Day Money-Back Guarantee</span>
              </div>
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
      ...
      <section className="border-t border-border bg-muted/30">
        <div className="container py-6">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-muted-foreground">
            <div className="flex items-center gap-1.5"><Truck className="w-3.5 h-3.5 text-primary" /> Fast US Shipping (3-7 Days)</div>
            <div className="flex items-center gap-1.5"><RotateCcw className="w-3.5 h-3.5 text-primary" /> 30-Day Money-Back Guarantee</div>
