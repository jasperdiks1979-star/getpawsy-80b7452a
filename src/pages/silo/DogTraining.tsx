  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Shop dog training harnesses, leashes & behavior tools. No-pull designs, reflective stitching, adjustable fit. US 3–7 day shipping. 30-day guarantee." />
        ...
        <div className="container px-4 md:px-6">
          <FadeInView className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed mb-6">
              No-pull harnesses, training leashes, and behavior tools — everything you need to build a better bond with your dog. All shipped from US warehouses in 3–7 days.
            </p>
