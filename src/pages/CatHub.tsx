...
const CatHub = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Cat Training & Travel Gear – US 3–7 Day Shipping | GetPawsy</title>
        <meta name="description" content="Shop cat trees, carriers, enrichment toys & scratching posts. US warehouse shipping 3–7 days. 30-day guarantee." />
