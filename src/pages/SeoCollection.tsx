    ...
    <Layout>
      ...
      <div className="container py-8 md:py-12">
        ...
        <div className="flex flex-wrap items-center gap-3 md:gap-6 py-2 px-3 mb-3 rounded-lg bg-secondary/20 border border-secondary/40 text-xs text-secondary-foreground">
          <span className="flex items-center gap-1.5"><Truck className="w-3.5 h-3.5 text-primary" /> Free US Shipping $49+</span>
        ...
        {domConfig && (
          <MidContentCTA
            ...
            subtext="Browse our curated selection — every product is quality-tested with free US shipping over $49."
            ctaText="Shop Now"
            ctaHref="#products"
          />
        )}
