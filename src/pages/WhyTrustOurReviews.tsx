  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="GetPawsy's editorial team researches 15–20 hours per guide. Learn our testing methodology, editorial independence policy, and how we rank products for US pet owners." />
