...
import {
  ...
  RefreshCw, SkipForward, Terminal, ChevronDown, ChevronUp,
} from 'lucide-react';
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Execute GSC sync, crawl health, orphan detection, CTR recovery & ranking push
            </CardDescription>
          </div>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            {isActive ? 'Run in progress…' : 'Run all now'}
          </Button>
        </div>
...
function LogLine({ log }: { log: JobRunLog }) {
  ...
  return (
    <div className={cn("flex gap-2", levelColors[log.level])}>
      ...
      <span className="uppercase font-bold w-10 shrink-0 text-right">
        {log.level}
      </span>
