...
function generateContent(name: string, cat: string): ContentBlock {
  ...
  return {
    ...
    paragraphs: [
      ...
      `Backed by our 30-day satisfaction guarantee and responsive customer support, you can try it with complete confidence. Fast shipping from US-based fulfillment means your pet won't have to wait long to enjoy their new favorite thing.`,
    ],
    highlights: [
