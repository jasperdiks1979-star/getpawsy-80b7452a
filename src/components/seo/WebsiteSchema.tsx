    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'Dog Beds',
        url: `${url}/collections/orthopedic-calming-dog-beds`,
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Cat Condos & Furniture',
        url: `${url}/collections/cat-condos`,
      },
      {
        '@type': 'ListItem',
        position: 3,
      ...
      },
      {
        ...
        url: `${url}/collections/best-cat-litter-boxes`,
      },
      {
        '@type': 'ListItem',
        position: 5,
        name: 'Cat Toys for Indoor Cats',
        url: `${url}/collections/best-cat-toys-for-indoor-cats`,
      },
      {
        '@type': 'ListItem',
        position: 6,
        name: 'Dog Grooming Kits',
        url: `${url}/collections/best-dog-grooming-kits`,
      },
    ],
  };
