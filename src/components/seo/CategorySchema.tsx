...
export function CategorySchema({
  ...
  const pageDescription = isSearch
    ? `Found ${productCount} products for "${searchQuery}". Shop premium pet supplies at GetPawsy with free US shipping on orders over $49.`
    : categoryName
      ? `Shop our collection of ${productCount}+ ${categoryName.toLowerCase()} at GetPawsy. Premium quality ${categoryName.toLowerCase()} for your beloved pets. Free US shipping over $49, vet-approved products.`
      : `Browse ${productCount}+ premium pet products at GetPawsy. Quality dog beds, cat trees, pet toys, collars, and more. Free US shipping on orders over $49.`;
