    ...
    <div className="max-w-4xl mb-16 space-y-12">
      ...
      <section className="bg-primary/5 border border-primary/20 rounded-2xl p-6 md:p-8 text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-lg mx-auto">
          Every cat tree in our collection is curated for stability, durability, and cat-approved design. Free US shipping on orders over $35 with a 30-day satisfaction guarantee.
        </p>
