...
export const CTR_WARFARE_UPGRADES: CTRUpgrade[] = [
  {
    ...
    getpawsyDesc: 'Front-clip harnesses that reduce pulling by 40–60% in 1 walk. Tested by certified trainers. Sizes for 5–150 lb dogs. Free US shipping over $49.',
