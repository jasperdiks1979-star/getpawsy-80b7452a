...
export const NICHE_KEYWORD_RESEARCH: NicheConfig[] = [
  ...
  },
  {
    ...
    shop_page: '/collections/best-cat-litter-boxes',
    guide_page: '/guides/best-cat-litter-box-2026',
    supporting_keywords: [
      { keyword: 'best cat litter box', intent: 'transactional', estimated_volume_range: '10K–100K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: ['/guides/best-cat-litter-box-2026'] },
      { keyword: 'self cleaning litter box', intent: 'transactional', estimated_volume_range: '10K–100K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: ['/guides/self-cleaning-litter-box-worth-it'] },
      { keyword: 'enclosed litter box', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: [] },
      { keyword: 'odor control litter box', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: [] },
      { keyword: 'litter box for large cats', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: [] },
      { keyword: 'automatic litter box', intent: 'transactional', estimated_volume_range: '10K–100K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: ['/guides/self-cleaning-litter-box-worth-it'] },
      { keyword: 'litter box furniture', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: ['/guides/best-cat-litter-box-furniture-enclosures-2026'] },
      { keyword: 'covered litter box', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: [] },
      { keyword: 'top entry litter box', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: [] },
      { keyword: 'best litter box for multi cat home', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: [] },
      { keyword: 'is self cleaning litter box worth it', intent: 'informational', estimated_volume_range: '1K–10K', target_page: '/guides/self-cleaning-litter-box-worth-it', internal_link_targets: ['/collections/best-cat-litter-boxes'] },
      { keyword: 'how to reduce litter box smell', intent: 'informational', estimated_volume_range: '100–1K', target_page: '/guides/best-cat-litter-box-2026', internal_link_targets: ['/collections/best-cat-litter-boxes'] },
      { keyword: 'litter box enclosure', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: [] },
      { keyword: 'smart litter box', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: [] },
      { keyword: 'cat litter box cabinet', intent: 'transactional', estimated_volume_range: '1K–10K', target_page: '/collections/best-cat-litter-boxes', internal_link_targets: [] },
    ],
  },
  {
