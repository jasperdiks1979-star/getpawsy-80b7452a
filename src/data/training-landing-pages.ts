...
export const NO_PULL_HARNESS_LANDING: LandingPageData = {
  ...
  primaryProduct: {
    ...
    price: 43.99,
    image: 'https://cf.cjdropshipping.com/a43f0bf9-74bf-4422-83b1-39e968724c6f.jpg',
  ...
  bundle: {
    ...
    items: [
      ...
      },
      {
        ...
        price: 40.95,
        image: 'https://cf.cjdropshipping.com/17660160/a9df520c-1771-424e-ba01-9f105339cfb6.jpg',
        shortName: 'Treat Pouch',
      },
    ],
  },
  ctaText: 'Get Your No-Pull Harness',
  ctaSubtext: 'Free US Shipping over $49 • 30-Day Guarantee',
  adAngle: 'pain',
};
...
export const STOP_PULLING_LANDING: LandingPageData = {
  ...
  primaryProduct: {
    ...
    price: 44.49,
    image: 'https://cf.cjdropshipping.com/87180ca6-5724-49bf-b290-5b845721e0f9.jpg',
