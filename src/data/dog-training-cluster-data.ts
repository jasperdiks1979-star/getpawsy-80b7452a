...
export const PULLING_CLUSTER: TrainingClusterData[] = [
  {
    ...
    faq: [
      ...
      { question: 'Do no-pull harnesses ship from US warehouses?', answer: 'Our no-pull harnesses ship directly to customers with standard delivery in 3–7 business days. Free shipping on orders over $35. All harnesses include a sizing guarantee — exchange for free if the fit isn\'t right.' },
    ],
