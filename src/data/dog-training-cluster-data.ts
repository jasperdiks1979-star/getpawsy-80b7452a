...
export const HARNESS_CLUSTER: TrainingClusterData[] = [
  ...
  },
  {
    ...
    title: 'Best No-Pull Harness for Large Dogs (2026) — Compared & Ranked',
    metaTitle: 'Best No-Pull Harness for Large Dogs (2026) | GetPawsy',
    metaDescription: 'carefully selected no-pull harnesses for large breeds (50+ lbs). Heavy-duty construction, front-clip steering, reflective safety. US shipping.',
    heroSubtitle: 'Large breeds need harnesses built to handle serious pulling force. We compared the strongest options for Labs, German Shepherds, and giant breeds.',
...
export const HIJACK_CLUSTER: TrainingClusterData[] = [
  {
    ...
    heroSubtitle: 'Standard harnesses fail big dogs. We compared tactical-grade anti-pull options built for 50–150 lb breeds that pull hard.',
  ...
  },
  {
    ...
    metaDescription: 'No-pull harness vs Gentle Leader head halter comparison. Pros, cons, safety, and which works best for your dog. Trainer-approved guide. Free shipping available.',
