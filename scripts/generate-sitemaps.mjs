...
async function main() {
  ...
  const staticPages = [
    ...
    { path: "/bestsellers", priority: 0.85, changefreq: "weekly", lastmod: today },
    ...
    { path: "/faq", priority: 0.30, changefreq: "monthly", lastmod: today },
    { path: "/blog", priority: 0.70, changefreq: "daily", lastmod: today },
    { path: "/dog", priority: 0.85, changefreq: "weekly", lastmod: today },
    { path: "/cat", priority: 0.85, changefreq: "weekly", lastmod: today },
    { path: "/trending-pet-products", priority: 0.70, changefreq: "daily", lastmod: today },
