...
const MERCHANT_TOP80_IDS = new Set([
  ...
  // CJTC276169401AZ discontinued by the supplier.
...
function sanitizeProductForMerchant(p: RawProduct): SanitizeResult {
  ...
  result.product = {
    ...
    availability: (p as any).availability || ((p as any).stock > 0 ? "in stock" : "out of stock"),
    ...
    identifier_exists: (p as any).identifier_exists ? "yes" : "no",
    ...((p as any).gtin ? { gtin: (p as any).gtin } : {}),
    ...((p as any).mpn ? { mpn: (p as any).mpn } : {}),
