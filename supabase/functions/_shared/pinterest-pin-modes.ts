...
export const PIN_MODES: Record<PinModeKey, PinMode> = {
  ...
  before_after: {
    key: "before_after",
    label: "Before / After",
    psychology: "quiet transformation — a single calm 'after' moment pinners save",
    composition_rule:
      "single editorial lifestyle scene of the calm 'after' state — clean tidy home, content pet, product naturally integrated. NEVER a split layout, NEVER a comparison graphic, NEVER side-by-side tiles.",
    ...
    must_avoid: [...COMMON_AVOID, "split-screen", "before/after labels", "comparison tiles", "exaggerated dirt or distress", "shock imagery"],
    must_have: ["single calm scene", "product naturally in scene"],
    is_collage: false,
  },
  emotional_pain: {
    key: "emotional_pain",
  ...
  moodboard_collage: {
    ...
    composition_rule:
      "single wide editorial interior shot styled like a curated moodboard come to life — refined materials, layered textures, product naturally placed. NEVER multi-tile, NEVER collage, NEVER split layouts.",
    palette: "warm cohesive neutral palette",
    typography_hint: "serif refined",
    cta_tone: "soft",
    safe_area: { headline_top_pct: 10, cta_bottom_pct: 10, subject_focus_pct: 50 },
    must_avoid: [...COMMON_AVOID, "multi-tile collage", "split layout", "harsh borders", "white background tiles"],
    must_have: ["unified palette", "single editorial scene"],
    is_collage: false,
  },
  product_lifestyle_blend: {
