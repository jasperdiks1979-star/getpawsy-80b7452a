// pinterest-content-repair-orchestrator — REMOVED (P0 architecture remediation 2026-06-26).
//
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    await sb.from("guardian_publish_gate_log").insert({
      pipeline: "pinterest-content-repair-orchestrator",
      decision: "deny",
  ...
  return new Response(
    JSON.stringify({
      ...
      message: "pinterest-content-repair-orchestrator has been retired. Enqueue into pcie2_publish_queue; pcie2-publisher is the only canonical Pinterest publisher.",
